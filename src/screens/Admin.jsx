...
function Admin() {
    ...
    useEffect(() => {
        axios.get('https://ecommerceback.onrender.com/api/Product').then((res) => {
    ...
    const Handlesubmit = () => {
        axios.post('https://ecommerceback.onrender.com/api/Product', {
            name,
            price,
            image,
            description
    ...
    const Delete = (id) => {
        axios.delete(`https://ecommerceback.onrender.com/api/Product/${id}`).then((res) => {
